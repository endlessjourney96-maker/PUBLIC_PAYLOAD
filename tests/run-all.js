...
const suites = [
  ...
  'tests/diagnosis-uom-adapter.test.js',
...
console.log('MVP preflight: engine + catalog + recommendation + UOM + diagnosis adapter + analytics/assets + browser bridge + worker contracts OK');
